    ...
    if (res.data && res.data.success && res.data.data?.token) {
      ...
      toast.promise(
            loginPromise,
            {
                ...
                success: (data) => "Welcome back! 🎉 Admin ",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to manage your agents and data</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-500">Secure admin access with JWT authentication</p>
        </div>
      </div>
    </div>
  )
